...
class Pagination {
    ...
    /**
     * Le tableau d'options précisant la recherche de la méthode findBy
     *
     * @var array
     */
     ...
     * - category => l'id de la catégorie d'articles
     *
    ...
    /**
     * Get le tableau d'options précisant la recherche de la méthode findBy
     *
     * @return  array
     */ 
